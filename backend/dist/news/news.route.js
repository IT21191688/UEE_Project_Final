...
NewsRouter.patch("/updateNews/:id", auth_middleware_1.default.authorize([constant_1.default.USER.ROLES.ADMIN]), common_middleware_1.default.multerUploader.single("newsImage"), news_controller_1.UpdateNews);
