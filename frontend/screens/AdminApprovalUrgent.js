...
const AdminApprovalUrgent = () => {
  const navigation = useNavigation();
    const handleNavigateGeneral = () => {
  ...
  return (
    <View style={styles.myNews}>
      ...
      <View style={styles.btnsetcontainer}>
        <Pressable style={styles.button1} onPress={() => console.log('Button 1 clicked!')}>
          <Text style={styles.buttonText1} >Urgent</Text>
        </Pressable>
        <Pressable style={styles.button} onPress={handleNavigateGeneral}>
...
const styles = StyleSheet.create({
    scrollableSectionScrollViewContent: {
      ...
      dateText1: {
        color: '#FF9228', // Change to your desired text color
        fontSize: 12,
        fontWeight: '500',
        lineHeight: 19.2,
        top: -20,
...
export default AdminApprovalUrgent;
