...
const DeleteMsgCertificates = () => {
  ...
  return (
    <View style={styles.splashScreenCertificates}>
      ...
      />
      <Text style={styles.verifyText}>Delete Successfull</Text>
      <Text style={styles.paragraph}>You’ve successfully deleted a certificate.  </Text>
...
export default DeleteMsgCertificates;
