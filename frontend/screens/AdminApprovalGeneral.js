    ...
    <View style={styles.myNews}>
      ...
      <View style={styles.btnsetcontainer}>
        <Pressable style={styles.button} onPress={() => console.log('Button 1 clicked!')}>
          <Text style={styles.buttonText}onPress={handleNavigateUrgent}>Urgent</Text>
        </Pressable>
        <Pressable style={styles.button1} onPress={() => console.log('Button 2 clicked!')}>
          <Text style={styles.buttonText1}>General</Text>
        </Pressable>
