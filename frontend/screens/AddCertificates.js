...
const AddCertificates = () => {
    ...
    const handleNavigate = () => {
        navigation.navigate("PaymentUI"); // Replace "OtherScreen" with the name of the screen you want to navigate to
      };
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.form} showsVerticalScrollIndicator={false}>
                ...
                >
                    <Text style={styles.buttonText} onPress={handleNavigate}>Proceed to Payment</Text>
                </Pressable>
            </ScrollView>
        </View>
    );
