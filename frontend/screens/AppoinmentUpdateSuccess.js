...
const AppoinmentUpdateSuccess = () => {
    ...
    return (
        <View style={styles.appointmentView}>
            ...
            />
            <Text style={styles.successText}>Update Success</Text>

            <Text style={styles.contentText}>
                You’ve successfully update an appointment. Please check your emails for updates.
            </Text>
...
export default AppoinmentUpdateSuccess;
