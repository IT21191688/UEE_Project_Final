...
const EditCertificate = () => {
    ...
    const handleNavigate = () => {
        navigation.navigate("UpdateMsgCertificates"); // Replace "OtherScreen" with the name of the screen you want to navigate to
      };
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.appointmentText}>Update Certificates </Text>
            ...
            <ScrollView style={styles.form} showsVerticalScrollIndicator={false}>
                ...
                >
                    <Text style={styles.buttonText} onPress={handleNavigate}>Submit</Text>
                </Pressable>
            </ScrollView>
        </View>
    );
