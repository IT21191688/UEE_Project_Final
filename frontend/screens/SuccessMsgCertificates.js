...
const SuccessMsgCertificates = () => {
  ...
  return (
    <View style={styles.splashScreenCertificates}>
      ...
      <Text style={styles.paragraph}>You’ve successfully requested a certificate. </Text>
      <Text style={styles.paragraph}> Please check your emails for updates.</Text>
...
export default SuccessMsgCertificates;
